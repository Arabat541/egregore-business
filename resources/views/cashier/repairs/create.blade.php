        ...
        <div class="col-md-4">
            ...
            <div class="card sticky-top" style="top: 20px;">
                ...
                <div class="card-body">
                    ...
                    <!-- Récapitulatif avance et reste -->
                    <div class="card bg-info bg-opacity-10 border-info mb-3">
                        <div class="card-body py-2">
                            <div class="d-flex justify-content-between">
                                <span><i class="bi bi-wallet2"></i> Minimum requis (pièces) :</span>
                                <span id="advanceDisplay" class="fw-bold text-primary">0 FCFA</span>
                            </div>
                            <div class="d-flex justify-content-between text-muted">
                                <span><i class="bi bi-cash-stack"></i> Total réparation :</span>
                                <span id="fullTotalDisplay" class="fw-bold">0 FCFA</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-outline-success flex-fill payment-type-btn" data-type="full" id="btnPayFull">
                                <i class="bi bi-cash-stack"></i> Totalité
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mb-3" id="remainingBlock">
                        <div class="d-flex justify-content-between text-muted">
                            ...
                            <span id="remainingDisplay" class="fw-bold">0 FCFA</span>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateChange() {
        const toPay = parseInt(amountPaid.value) || 0;
        ...
        if (toPay === 0) {
            ...
            changeAmount.textContent = 'Aucun paiement requis';
        } else if (given > 0 && given >= toPay) {
            ...
            changeAmount.textContent = 'Insuffisant: ' + formatNumber(toPay - given) + ' FCFA manquants';
        } else {
