        ...
        <div class="col-md-4">
            <div class="card sticky-top" style="top: 16px;">
                ...
                <div class="card-body border-top pt-2">
                    ...
                    <div class="d-flex justify-content-between mb-1" id="subtotalRow" style="display:none">
                    ...
                    <div class="d-flex justify-content-between mb-2" id="changeSection" style="display:none">
