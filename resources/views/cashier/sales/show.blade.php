...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="{{ route('cashier.sales.edit', $sale) }}" class="btn btn-warning">
        ...
        <div class="modal-content">
            <form action="{{ route('cashier.sales.cancel', $sale) }}" method="POST">
                ...
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title"><i class="bi bi-x-circle me-2"></i>Annuler la vente</h5>
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Le stock des <strong>{{ $sale->item_count }} article(s)</strong> sera restauré.
                        Le montant encaissé <strong>{{ number_format($sale->amount_paid, 0, ',', ' ') }} FCFA</strong>
                        devra être remboursé manuellement si nécessaire.
                    </div>
                    <div class="mb-3">
