        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Remplacement de pièce pour SAV réparation -->
                    @if($sav->repair_id && in_array($sav->type, ['repair_warranty', 'warranty']))
                        <hr class="my-3">
                        <a href="{{ route('sav.replace-part', $sav) }}" class="btn btn-warning w-100">
                            <i class="bi bi-arrow-repeat me-2"></i>
                            Remplacer une pièce défectueuse
                        </a>
                        <small class="text-muted d-block mt-2">
                            <i class="bi bi-info-circle me-1"></i>
                            Le coût sera déduit du CA du technicien
                        </small>
                    @endif
                </div>
            </div>
