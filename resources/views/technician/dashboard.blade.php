...
<!-- Chiffre d'affaires réparations -->
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card border-success">
            <div class="card-body text-center">
                <h5 class="text-muted mb-1"><i class="bi bi-calendar-day"></i> CA Réparations Jour</h5>
    ...
    <div class="col-md-6">
        <div class="card border-primary">
            <div class="card-body text-center">
                <h5 class="text-muted mb-1"><i class="bi bi-calendar-month"></i> CA Réparations Mois</h5>
