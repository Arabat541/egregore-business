                ...
                <table class="table table-sm">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="2">{{ number_format($repair->parts->sum('total_cost'), 0, ',', ' ') }} FCFA</th>
                        </tr>
                    </tfoot>
                </table>
                @else
                        ...
                        <select class="form-select" name="product_id" id="productSelect">
                            ...
                            @foreach($products ?? [] as $product)
                                <option value="{{ $product->id }}" data-price="{{ $product->normal_price }}">
                                    {{ $product->name }} (Stock: {{ $product->quantity_in_stock }}) - {{ number_format($product->normal_price, 0, ',', ' ') }} FCFA
                                </option>
                            @endforeach
                        </select>
                    </div>
