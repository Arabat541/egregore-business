...
<head>
    ...
    <title>Facture - {{ $publicSale['invoice_number'] }}</title>
        ...
        <div class="tracking-card">
            <div class="invoice-header">
                ...
                <div class="invoice-number">
                    <i class="fas fa-hashtag me-1"></i>{{ $publicSale['invoice_number'] }}
                </div>
            </div>
            ...
            <div class="tracking-body">
                ...
                <div class="info-section">
                    ...
                    <div class="info-content">
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ \Carbon\Carbon::parse($publicSale['created_at'])->format('d/m/Y à H:i') }}</span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Statut</span>
                            <span class="info-value">
                                @if($publicSale['payment_status'] === 'paid')
                                    <span class="payment-badge paid"><i class="fas fa-check me-1"></i>Payée</span>
                                @elseif($publicSale['payment_status'] === 'partial')
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $publicSale['customer_name'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                {{-- Articles --}}
                <div class="info-section">
                    <h5><i class="fas fa-shopping-cart"></i> Articles ({{ count($publicSale['items']) }})</h5>
                    <div class="info-content p-0">
                        <table class="items-table">
                            ...
                            <tbody>
                                @foreach($publicSale['items'] as $item)
                                <tr>
                                    <td>
                ...
                <div class="totals-section">
                    <div class="total-row grand-total">
                        <span>Total</span>
                        <span class="total-value">{{ number_format($publicSale['total_amount'], 0, ',', ' ') }} FCFA</span>
                    </div>
                </div>
