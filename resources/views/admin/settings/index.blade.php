            ...
            <form action="{{ route('admin.settings.update') }}" method="POST">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="repair_warranty_days" class="form-label">Garantie réparation (jours)</label>
                                ...
                                <small class="text-muted">Durée de garantie après livraison d'une réparation</small>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="repair_default_diagnostic_fee" class="form-label">Frais diagnostic (FCFA)</label>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-cart-check me-2"></i>Ventes & S.A.V</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="sale_warranty_days" class="form-label">Garantie vente (jours)</label>
                        ...
                        <div class="alert alert-info mb-0">
                            <i class="bi bi-info-circle"></i> Après ces délais de garantie, aucun ticket S.A.V (retour, échange, remboursement) ne pourra être créé.
                        </div>
                    </div>
                </div>
