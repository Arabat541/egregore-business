...
<div class="mb-3">
    <div class="form-check form-switch">
        ...
        <label class="form-check-label">Réparateur actif</label>
    </div>
</div>

<div class="mb-3">
    <div class="form-check form-switch">
        <input class="form-check-input" type="checkbox" name="credit_allowed" value="1" 
               {{ old('credit_allowed', $reseller->credit_allowed ?? true) ? 'checked' : '' }}>
        <label class="form-check-label">Crédit autorisé</label>
    </div>
</div>
...
<div class="d-flex justify-content-end gap-2">
    <a href="{{ route(($routePrefix ?? 'admin') . '.resellers.index') }}" class="btn btn-outline-secondary">Annuler</a>
