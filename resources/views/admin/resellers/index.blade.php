...
@section('title', 'Gestion des réparateurs')
...
<div class="card mb-4">
    <div class="card-body">
        <form action="{{ route($routePrefix . '.resellers.index') }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <a href="{{ route($routePrefix . '.resellers.index') }}" class="btn btn-outline-secondary w-100">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="{{ !$reseller->is_active ? 'table-secondary opacity-75' : '' }}">
                        ...
                        <td>
                            <a href="{{ route($routePrefix . '.resellers.show', $reseller) }}" class="btn btn-sm btn-outline-info">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route($routePrefix . '.resellers.edit', $reseller) }}" class="btn btn-sm btn-outline-primary">
