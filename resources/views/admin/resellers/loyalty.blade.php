...
@section('title', 'Rapport de Fidélité - Réparateurs')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Programme de fidélité réparateurs - Année {{ $year }}</p>
        </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm bg-primary text-white">
                <div class="card-body text-center">
                    ...
                    <h6 class="text-white-50">Réparateurs Actifs</h6>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-table me-2"></i>Détail par Réparateur</h5>
