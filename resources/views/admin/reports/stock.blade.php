...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('admin.reports.stock.pdf', ['shop_id' => $shopId ?? '', 'category_id' => $categoryId ?? '']) }}"
                            ...
                            <tbody>
                                @forelse($mostProfitable as $product)
                                    <tr>
                                        ...
                                        <td class="text-end">{{ number_format($product->normal_price, 0, ',', ' ') }}</td>
                                    ...
                                    <div class="card border">
                                        <div class="card-body py-2">
                                            ...
                                            <p class="text-muted mb-0 small">
                                                ...
                                                | {{ number_format($product->normal_price, 0, ',', ' ') }} F
                                            </p>
                                        </div>
                                    </div>
                                </div>
