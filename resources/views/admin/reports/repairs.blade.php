...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('admin.reports.repairs.pdf', ['start_date' => $startDate, 'end_date' => $endDate, 'shop_id' => $shopId ?? '']) }}"
    ...
    <div class="alert alert-light border d-flex flex-wrap gap-4 align-items-center py-2 mb-3">
        ...
        <span>
            ...
            @if($n1RepGrowth !== null)
                <span class="ms-1 {{ $n1RepGrowth >= 0 ? 'text-success' : 'text-danger' }}">
                    <i class="bi bi-arrow-{{ $n1RepGrowth >= 0 ? 'up' : 'down' }}-short"></i>{{ abs($n1RepGrowth) }}%
                </span>
            @else
        ...
        <span>Réparations : <strong>{{ $n1Repairs }}</strong></span>
    </div>
    @endif
