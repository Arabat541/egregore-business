...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            <a href="{{ route('admin.reports.customers.pdf', ['start_date' => $startDate, 'end_date' => $endDate, 'shop_id' => $shopId ?? '', 'customer_type' => $customerType ?? '']) }}"
            ...
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <select name="customer_type" class="form-select">
                        <option value="">Tous (clients + réparateurs)</option>
                        <option value="customer" {{ (isset($customerType) && $customerType === 'customer') ? 'selected' : '' }}>
                            Clients particuliers
                        </option>
                        <option value="reseller" {{ (isset($customerType) && $customerType === 'reseller') ? 'selected' : '' }}>
                            Réparateurs / Revendeurs
                        </option>
                    </select>
                </div>
                <div class="col-md-2">
                            ...
                            <tbody>
                                @forelse($topResellers as $index => $reseller)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.resellers.report-statement', $reseller) }}?start_date={{ $startDate }}&end_date={{ $endDate }}" class="btn btn-sm btn-outline-danger" title="Relevé de créance">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">Aucun revendeur actif sur cette période</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
