...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('sav.index') }}" class="btn btn-outline-primary">
                <i class="bi bi-list me-2"></i>Voir tickets
            </a>
            <a href="{{ route('admin.reports.sav.pdf', ['start_date' => $startDate, 'end_date' => $endDate, 'shop_id' => $shopId ?? '', 'sav_type' => $savType ?? '', 'customer_type' => $customerType ?? '']) }}"
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <label class="form-label">Type SAV</label>
                    <select name="sav_type" class="form-select">
                        <option value="">Tous les types</option>
                        <option value="return"           {{ (isset($savType) && $savType === 'return')           ? 'selected' : '' }}>Retour</option>
                        <option value="exchange"         {{ (isset($savType) && $savType === 'exchange')         ? 'selected' : '' }}>Échange</option>
                        <option value="refund"           {{ (isset($savType) && $savType === 'refund')           ? 'selected' : '' }}>Remboursement</option>
                        <option value="warranty"         {{ (isset($savType) && $savType === 'warranty')         ? 'selected' : '' }}>Garantie</option>
                        <option value="repair_warranty"  {{ (isset($savType) && $savType === 'repair_warranty')  ? 'selected' : '' }}>Garantie répar.</option>
                        <option value="complaint"        {{ (isset($savType) && $savType === 'complaint')        ? 'selected' : '' }}>Réclamation</option>
                        <option value="other"            {{ (isset($savType) && $savType === 'other')            ? 'selected' : '' }}>Autre</option>
                    </select>
                </div>
                <div class="col-md-2">
                    ...
                    <select name="customer_type" class="form-select">
                        ...
                        <option value="customer"  {{ (isset($customerType) && $customerType === 'customer')  ? 'selected' : '' }}>Particuliers</option>
                        <option value="reseller"  {{ (isset($customerType) && $customerType === 'reseller')  ? 'selected' : '' }}>Réparateurs</option>
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-auto">
                    <a href="{{ route('admin.reports.sav') }}" class="btn btn-outline-secondary" title="Réinitialiser">
