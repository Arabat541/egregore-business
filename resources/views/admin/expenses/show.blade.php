...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-receipt me-2"></i>Informations
                    </h5>
                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label class="text-muted small">Boutique</label>
                            <p class="mb-2">
                                <span class="badge bg-dark">
                                    <i class="fas fa-store me-1"></i>{{ $expense->shop->name ?? '-' }}
                                </span>
                            </p>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-2">
                                @switch($expense->payment_method)
                                    @case('cash')
                                        <span class="badge bg-success"><i class="fas fa-money-bill me-1"></i>Espèces</span>
                                        @break
                                    @case('bank_transfer')
                                        <span class="badge bg-info"><i class="fas fa-university me-1"></i>Virement bancaire</span>
                                        @break
                                    @case('mobile_money')
                                        <span class="badge bg-warning text-dark"><i class="fas fa-mobile-alt me-1"></i>Mobile Money</span>
                                        @break
                                    @case('check')
                                        <span class="badge bg-secondary"><i class="fas fa-money-check me-1"></i>Chèque</span>
                                        @break
                                @endswitch
                            </p>
                        </div>
            ...
            @if($expense->receipt_image)
                <div class="card shadow-sm mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-image me-2"></i>Photo du reçu</h5>
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header">
                    <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i>Suivi</h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    @if($expense->status === 'pending')
                        <form action="{{ route('admin.expenses.approve', $expense) }}" method="POST" class="mb-2">
                            @csrf
                            <button type="submit" class="btn btn-success w-100">
                                <i class="fas fa-check me-1"></i> Approuver
                            </button>
                        </form>
                        <form action="{{ route('admin.expenses.reject', $expense) }}" method="POST" class="mb-2">
                            @csrf
