...
<div class="row mb-4">
    ...
    <div class="col-md-3">
        <div class="card bg-warning text-dark">
            <div class="card-body text-center">
                <h3 class="mb-0">{{ number_format($totals['profit_today'] ?? 0, 0, ',', ' ') }} F</h3>
                <small>Bénéfice du jour</small>
            </div>
        </div>
    </div>
    <div class="col-md-2">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    @foreach($shops as $shop)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <span class="fw-bold {{ ($shop->today_profit ?? 0) >= 0 ? 'text-primary' : 'text-danger' }}">{{ number_format($shop->today_profit ?? 0, 0, ',', ' ') }} F</span>
                            </td>
                ...
                <tfoot class="table-secondary">
                    <tr>
                        ...
                        <th class="text-end text-primary">{{ number_format($totals['profit_today'] ?? 0, 0, ',', ' ') }} F</th>
