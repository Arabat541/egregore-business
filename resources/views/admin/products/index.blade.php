    ...
    <div>
        <div class="dropdown d-inline-block me-2">
            <button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">
                <i class="bi bi-file-pdf"></i> Liste des prix
            </button>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('admin.products.prices-pdf') }}">
                    <i class="bi bi-shop"></i> Toutes les boutiques
                </a></li>
                <li><hr class="dropdown-divider"></li>
                @foreach($shops as $shop)
                <li><a class="dropdown-item" href="{{ route('admin.products.prices-pdf', ['shop_id' => $shop->id]) }}">
                    <i class="bi bi-shop-window"></i> {{ $shop->name }}
                </a></li>
                @endforeach
            </ul>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($product->normal_price, 0, ',', ' ') }} F</td>
                        <td>
