    ...
    <div class="card-body">
        <form action="{{ isset($product) ? route('admin.products.update', $product) : route('admin.products.store') }}" method="POST">
            ...
            <div class="alert alert-info">
                ...
                <ul class="mb-0 mt-2">
                    <li><strong>Prix normal</strong> : Client régulier (1-2 pcs)</li>
                    <li><strong>Prix réparateur</strong> : Réparateur (1-2 pcs)</li>
                    <li><strong>Prix demi-gros</strong> : Réparateur (3-9 pcs)</li>
                    <li><strong>Prix de gros</strong> : Réparateur (10+ pcs)</li>
                </ul>
            </div>
