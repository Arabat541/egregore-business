        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-sm">
                    ...
                    <tr>
                        <th>Prix normal <small class="text-muted">(1-2 pcs)</small></th>
                        <td class="fw-bold text-primary">{{ number_format($product->normal_price, 0, ',', ' ') }} FCFA</td>
                    </tr>
                    <tr>
                        <th>Prix réparateur <small class="text-muted">(1-2 pcs)</small></th>
                        <td class="fw-bold text-warning">{{ $product->reseller_price ? number_format($product->reseller_price, 0, ',', ' ') . ' FCFA' : '-' }}</td>
                    </tr>
                    <tr>
                        <th>Prix demi-gros <small class="text-muted">(3-9 pcs)</small></th>
                        <td class="fw-bold text-info">{{ $product->semi_wholesale_price ? number_format($product->semi_wholesale_price, 0, ',', ' ') . ' FCFA' : '-' }}</td>
                    </tr>
                    <tr>
                        <th>Prix de gros <small class="text-muted">(10+ pcs)</small></th>
                        <td class="fw-bold text-success">{{ $product->wholesale_price ? number_format($product->wholesale_price, 0, ',', ' ') . ' FCFA' : '-' }}</td>
                    </tr>
                    <tr>
                        <th>Marge (prix normal)</th>
                        <td>
                            @if($product->purchase_price > 0)
                                {{ number_format($product->normal_price - $product->purchase_price, 0, ',', ' ') }} FCFA
                                <span class="text-muted">({{ number_format(($product->normal_price - $product->purchase_price) / $product->purchase_price * 100, 1) }}%)</span>
                            @else
                                -
                            @endif
                        </td>
