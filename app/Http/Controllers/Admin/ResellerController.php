...
class ResellerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.resellers.index', compact('resellers', 'shops', 'routePrefix'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'phone' => ['required', 'string', \Illuminate\Validation\Rule::unique('resellers')->where('shop_id', $shopId)],
        ...
        return redirect()->route($route)
            ->with('success', 'Réparateur créé avec succès.');
    }
    ...
    public function update(Request $request, Reseller $reseller)
    {
        ...
        $validated = $request->validate([
            ...
            'company_name' => 'required|string|max:255',
            'contact_name' => 'required|string|max:255',
            'phone' => ['required', 'string', \Illuminate\Validation\Rule::unique('resellers')->where('shop_id', $shopId)->ignore($reseller->id)],
            'email' => 'nullable|email',
            'address' => 'nullable|string',
            'tax_number' => 'nullable|string',
            'credit_limit' => 'required|numeric|min:0',
        ...
        $route = $isAdmin ? 'admin.resellers.index' : 'cashier.resellers.index';
        return redirect()->route($route)
            ->with('success', 'Réparateur mis à jour avec succès.');
    }
    ...
    public function destroy(Reseller $reseller)
    {
        ...
        // Vérifier si le réparateur a des ventes
        ...
        $route = $isAdmin ? 'admin.resellers.index' : 'cashier.resellers.index';
        return redirect()->route($route)
            ->with('success', 'Réparateur supprimé avec succès.');
    }
