...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $settingKeys = [
            'company_name', 'company_phone', 'company_email', 'company_whatsapp', 'company_website',
            'company_facebook',
            'company_address', 'company_siret', 'company_tva',
            'invoice_prefix', 'quote_prefix', 'repair_prefix', 'default_tva_rate', 'invoice_footer',
            'repair_warranty_days', 'repair_default_diagnostic_fee', 'repair_terms', 'technician_labor_share',
            'sale_warranty_days',
        ...
        // Vider le cache des paramètres modifiés
        foreach ($settingKeys as $key) {
    ...
    public function backup(Request $request)
    {
        try {
            ...
            // Écrire un fichier .my.cnf temporaire pour ne pas exposer
            // le mot de passe dans la liste des processus (ps aux).
            $tmpCnf = tempnam(sys_get_temp_dir(), 'mybackup');
            ...
            return back()->with('error', $this->handleException($e, 'backup'));
        }
    }
