...
class UserController extends Controller
{
    ...
    {
        // Les comptes admin ne peuvent pas être modifiés via l'interface
        // (ni par un autre admin, ni par soi-même — le super-admin passe par Artisan/Tinker)
        if ($user->hasRole('admin')) {
            return back()->with('error', 'Les comptes administrateur ne peuvent pas être modifiés via l\'interface.');
        }
