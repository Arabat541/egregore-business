...
class ExpenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($validated['payment_method'] === 'cash' && $status === 'approved' && isset($cashRegister)) {
            ...
            DB::rollBack();
            return back()->with('error', $this->handleException($e, 'expense.store'));
        }
    }
    ...
    public function update(Request $request, Expense $expense)
    {
        ...
        try {
            ...
            DB::rollBack();
            return back()->withErrors(['error' => $this->handleException($e, 'Erreur lors de la mise à jour')]);
        }
    }
    ...
    public function destroy(Expense $expense)
    {
        ...
        try {
            ...
            DB::rollBack();
            return back()->withErrors(['error' => $this->handleException($e, 'Erreur lors de la suppression')]);
        }
    }
