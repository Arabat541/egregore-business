...
class ThermalPrinterService
{
    ...
    {
        $this->settings = [
            'shop_name' => Setting::get('shop_name', Setting::get('company_name', 'EGREGORE BUSINESS')),
            'shop_address' => Setting::get('shop_address', Setting::get('company_address', '')),
            'shop_phone' => Setting::get('shop_phone', Setting::get('company_phone', '')),
            ...
            'warranty_days' => (int) Setting::get('repair_warranty_days', 7),
        ];
    }
    ...
    public function centerText(string $text): string
    {
        ...
        $padding = (int) floor(($this->paperWidth - $textLength) / 2);
