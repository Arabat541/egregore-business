...
class Setting extends Model
{
    ...
    public static function getDefaults(): array
    {
        return [
            ...
            // ──────────────── Entreprise ────────────────
            'company_name'    => ['value' => 'EGREGORE BUSINESS', 'type' => 'string', 'group' => 'company', 'is_global' => true],
            'company_phone'   => ['value' => '',                 'type' => 'string', 'group' => 'company', 'is_global' => true],
            'company_email'   => ['value' => '',                 'type' => 'string', 'group' => 'company', 'is_global' => true],
            'company_whatsapp' => ['value' => '',                'type' => 'string', 'group' => 'company', 'is_global' => true],
            'company_address' => ['value' => '',                 'type' => 'string', 'group' => 'company', 'is_global' => true],
            ...
            // ──────────────── Réparations ────────────────
            // Part du technicien sur la main d'œuvre (en %). Le reste revient à l'admin/boutique.
            // Ex: 50 = 50% technicien, 50% admin. Pièces = 100% boutique.
            // La part ne se comptabilise que sur les réparations livrées (STATUS_DELIVERED).
            'technician_labor_share' => ['value' => '50', 'type' => 'integer', 'group' => 'repairs', 'is_global' => true],

            // ──────────────── Boutique (personnalisable par boutique) ────────────────
